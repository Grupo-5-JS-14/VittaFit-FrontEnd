      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          <div>
            ...
            <h2 className="font-black text-4xl md:text-5xl uppercase tracking-tight text-white leading-none">
              Nossa{" "}
              <span
                className={isDarkMode ? "text-[#f27825]" : "text-[#074334]"}
              >
                Estética
              </span>{" "}
              É O Foco
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 auto-rows-auto">
          {fotos.map((foto, index) => (
            ...
            >
              {/* Overlay de tom que muda conforme o tema selecionado */}
              <div
              ...
              {/* Tag interna sutil no canto da foto que aparece no hover */}
